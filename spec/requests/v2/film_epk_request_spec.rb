...
RSpec.describe 'movie details API' do
  ...
  it 'creates a film epk' do
    ...
    post '/api/v2/film_epk', headers: @headers_1, params: body, as: :json
  ...
  it 'updates an existing film epk records attributes' do
    ...
    patch "/api/v2/film_epk/#{@epk.id}", headers: @headers_1, params: body, as: :json
  ...
  it "deletes a film epk record and it's dependents" do
    ...
    delete "/api/v2/film_epk/#{@epk.id}", headers: @headers_1, params: body, as: :json
